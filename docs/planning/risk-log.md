...
> **Status:** Increment 1 risk treatment reconciled against the implemented `test` branch and hosted CI
> **Date:** 2026-09-16
...
| R-004 | multi-auth scope splits account identity or revocation | 4 | 4 | 16 | one UUID User; password/Google/Passkey as credential adapters; central AuthSession issuance/revocation; proof-required linking | provider creates second User or bypasses revocation | I1 | **Partially mitigated**; implementation/tests complete, configured real-provider smoke remains |
...
## Increment 1 control evidence — reconciled 2026-09-16
