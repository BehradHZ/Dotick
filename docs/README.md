...
اسناد پروژه بر اساس نقش و میزان اعتبارشان دسته‌بندی شده‌اند:
...
1. [`canonical/system-definition.md`](canonical/system-definition.md)
2. [`canonical/domain-model.md`](canonical/domain-model.md)
3. [`canonical/decision-register.md`](canonical/decision-register.md)
