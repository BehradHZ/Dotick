...
## Unreleased — Increment 0 foundation (2026-09-06)
...
- Prepared I1 readiness with canonical Inbox, authentication, deletion and sync/history constraints. Product Task/authentication flows are not yet implemented.
